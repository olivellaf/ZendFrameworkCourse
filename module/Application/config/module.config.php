            ...
            'test'  => array(
                ...
                'options' => array(
                    'route'    => '/test[/:var1][/:var2]', 
                        /**
                         * if we use this [:/var1:/var2], makes the two 
                         * variables mandatory. In this case won't work giving
                         * only one variable
                         * examples: 
                         *      /test/Ferran -> 404 Not Found
                         *      /test/Ferran/28 -> Correct!
                         */
                    'constraints' => array(
                                'var1' => '[a-zA-Z][a-zA-Z0-9_-]*',
                                'var2' => '[0-9_-]*',
                            ),
                    'defaults' => array(
                        '__NAMESPACE__' => 'Application\Controller',
